...
constexpr auto operator+(ConstexprString<N1> lhs, const char (&rhs)[N2]) {
  ...
  for (std::size_t i = 0; i < N1 - 1; ++i) result[i] = lhs.str_[i];
  std::size_t j = 0;
  for (std::size_t i = N1 - 1; i < N1 + N2 - 2; ++i, ++j) result[i] = rhs[j];
...
template <class T>
struct RemoveConstFromPointer {
  using type = T;
};
template <class T>
struct RemoveConstFromPointer<const T *> {
  using type = T *;
};

template <class T>
constexpr auto TypeOfPointer() {
  return CreateConstexprString("%p");
}

template <>
constexpr auto TypeOfPointer<char *>() {
  return CreateConstexprString("%s");
}

template <class T>
constexpr auto TypeOf() {
...
template <>
constexpr auto TypeOf<char>() {
  return CreateConstexprString("%c");
}
template <>
constexpr auto TypeOf<short>() {
  return CreateConstexprString("%hd");
}
template <>
constexpr auto TypeOf<int>() {
  return CreateConstexprString("%d");
}
template <>
constexpr auto TypeOf<long>() {
  return CreateConstexprString("%ld");
}
template <>
constexpr auto TypeOf<long long>() {
...
template <>
constexpr auto TypeOf<unsigned char>() {
  return CreateConstexprString("%hhu");
}
template <>
constexpr auto TypeOf<unsigned short>() {
  return CreateConstexprString("%hu");
}
template <>
constexpr auto TypeOf<unsigned int>() {
  return CreateConstexprString("%u");
}
template <>
constexpr auto TypeOf<unsigned long>() {
  return CreateConstexprString("%lu");
}
template <>
constexpr auto TypeOf<unsigned long long>() {
  return CreateConstexprString("%llu");
}
template <>
constexpr auto TypeOf<float>() {
  return CreateConstexprString("%f");
}
template <>
constexpr auto TypeOf<double>() {
  return CreateConstexprString("%f");
}
template <>
constexpr auto TypeOf<long double>() {
  return CreateConstexprString("%Lf");
}

template <class... Args>
constexpr auto GetPrintfFormat() {
  return (... + TypeOf<Args>());
}
...
template <class... Args>
auto GetPrintfFormat(Args... /*args*/) {
  constexpr auto str = impl::GetPrintfFormat<Args...>();
  return str;
}
